...
<body>
  ...
  <article class="galleriwidht">
          ...
          <div>
            ...
            <form action="su" method="get"> Välj antalet bilder som ska visas nedan:
    ...
    <div class="row">
        ...
        while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
            echo '<div class="column">
                   <img src="galleriimg/i ('.$row['id'].').jpg" style="width:100%" onclick="openModal();currentSlide('.$row['id'].')" class="hover-shadow cursor" alt="img">
               </div>';
      ...
      <div class="modal-content">
        ...
        while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
              ...
              echo '<div class="mySlides">
                   ...
                   <img src="galleriimg/i ('.$row['id'].').jpg" style="width:400px; height: 300px; text-align: center;" alt="pic">
                </div>';
        }
        ?>
        ...
        while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
              ...
              echo '<div class="column">
                   ...
                   <img class="demo cursor" src="galleriimg/i ('.$row['id'].').jpg" style="width:100%" onclick="currentSlide(1)" alt="'.$row['id'].'">
                </div>';
        }
        ?>
