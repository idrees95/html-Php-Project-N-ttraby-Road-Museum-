...
<head>
    ...
    <link rel="stylesheet" href="css/stylesheetroads.css">
</head>
...
<?php include("header.php"); ?>
    ...
    <article class="roads">
    <a class="goback" href="roads.php">Gå tillbaka</a>
        <h1>Hålvägen</h1>
        <p>GPS N56.19903° E15.54876° (P-plats N56.20387° E15.54759°)</p>
        <img class="img" src="img/pic1.jpg" alt="">
        <p>Ungefär 300 meter finns kvar av den så kallade hålvägen mellan Nättraby och österut mot Verstorp. En hålväg är en välutnyttjad stig som nötts ner så kraftigt att det bildats en fåra i marken. Denna hålväg är cirka 1000 år gammal. Foto: Peter Öjerskog, 2008.</p>
        ...
        <a class="nextarticle" href="road2.php">Klicka för att gå till nästa article</a>
    </article>
